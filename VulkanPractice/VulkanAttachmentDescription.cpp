...
VulkanAttachmentDescription::VulkanAttachmentDescription(VkSampleCountFlagBits sampleCount, VkFormat swapchainFormat, VkAttachmentLoadOp loadOp, VkAttachmentStoreOp storeOp, VkAttachmentLoadOp stencilLoadOp, VkAttachmentStoreOp stencilStoreOp, VkImageLayout initialLayout, VkImageLayout finalLayout, bool aliased)
{
...
VulkanAttachmentDescription::~VulkanAttachmentDescription()
{

}

VkAttachmentDescription*
VulkanAttachmentDescription::getDescription()
{
